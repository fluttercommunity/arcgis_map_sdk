...
fun BasemapStyle.getJsonValue(): String {
    ...
    return when (this) {
        ...
        BasemapStyle.ARCGIS_LIGHT_GRAY_BASE -> TODO()
        BasemapStyle.ARCGIS_LIGHT_GRAY_LABELS -> TODO()
        BasemapStyle.ARCGIS_DARK_GRAY -> "arcgisDarkGray"
        BasemapStyle.ARCGIS_DARK_GRAY_BASE -> TODO()
        BasemapStyle.ARCGIS_DARK_GRAY_LABELS -> TODO()
        ...
        BasemapStyle.ARCGIS_OCEANS_BASE -> TODO()
        BasemapStyle.ARCGIS_OCEANS_LABELS -> TODO()
        BasemapStyle.ARCGIS_TERRAIN -> "arcgisTerrain"
        BasemapStyle.ARCGIS_TERRAIN_BASE -> TODO()
        BasemapStyle.ARCGIS_TERRAIN_DETAIL -> TODO()
        ...
        BasemapStyle.ARCGIS_STREETS_RELIEF_BASE -> TODO()
        BasemapStyle.ARCGIS_TOPOGRAPHIC_BASE -> TODO()
        BasemapStyle.ARCGIS_CHARTED_TERRITORY_BASE -> TODO()
        BasemapStyle.ARCGIS_MODERN_ANTIQUE_BASE -> TODO()
        BasemapStyle.OSM_STANDARD -> "osmStandard"
        BasemapStyle.OSM_STANDARD_RELIEF -> "osmStandardRelief"
        BasemapStyle.OSM_STANDARD_RELIEF_BASE -> TODO()
        ...
        BasemapStyle.OSM_LIGHT_GRAY_BASE -> TODO()
        BasemapStyle.OSM_LIGHT_GRAY_LABELS -> TODO()
        BasemapStyle.OSM_DARK_GRAY -> "osmDarkGray"
        BasemapStyle.OSM_DARK_GRAY_BASE -> TODO()
        BasemapStyle.OSM_DARK_GRAY_LABELS -> TODO()
        BasemapStyle.OSM_STREETS_RELIEF_BASE -> TODO()
    }
}
